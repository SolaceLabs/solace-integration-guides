...
| com.solacesystems.integration.spring.MessageConsumer | messageConsumer |
| com.solacesystems.integration.spring.MessageProducer | messageProducer |
...
`<entry key="java.naming.provider.url" value="smfs://___IP:PORT___" />`
